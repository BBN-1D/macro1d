...
SYM_T permanent_symbols[] =
{
  ...
  /* Begin PDP-1D instructions */

  /* Link instructions */
  { DEFFIX, "tad",    0360000 },	/* twos complement addition */
  { DEFFIX, "szl",    0740020 },        /* skip if link zero */
  { DEFFIX, "snl",    0740000 },        /* skip, non-zero */
  { DEFFIX, "cll",    0740010 },        /* clear link */
  { DEFFIX, "cml",    0740004 },        /* complement link */
  { DEFFIX, "stl",    0740014 },        /* set link */
  { DEFFIX, "scm",    0740200 },        /* AC + Link */
  { DEFFIX, "ida",    0740400 },        /* increment link */

  /* Additional Operates and Skips */
  { DEFFIX, "sni",    0644000 },        /* skip if IO non-zero */
  { DEFFIX, "lai",    0760040 },        /* load from AC to IO */
  { DEFFIX, "lia",    0760020 },        /* load from IO to AC */
  { DEFFIX, "swp",    0760060 },        /* swap IO and AC */
  { DEFFIX, "cmi",    0770000 },        /* ones' complement for IO */
  { DEFFIX, "szi",    0654000 },	/* skip on zero IO */	


 /* Characters */
 /* There may be dragons beyond this point! */
 { DEFFIX, "lch",     0120000 },        /* load character */
 { DEFFIX, "dch",     0140000 },        /* deposit character */
 { DEFFIX, "idc",     0741000 },        /* index character */
 { DEFFIX, "sci",     0740200 },        /* clear IO */
 { DEFFIX, "scf",     0740100 },        /* clear program flags */
 { DEFFIX, "iif" ,    0744000 },        /* or IO from program flags */
 { DEFFIX, "ifi",     0742000 },        /* ...or  program flags from IO */

 /* Memory and Processor Control IOTs */

 { DEFFIX, "erg",     0720011 },        /* enter ring mode */
 { DEFFIX, "lrg",     0720010 },        /* .. .and leave it */
 { DEFFIX, "lrm",     0720064 },        /* leave restrict mode */
 { DEFFIX, "erm",     0720065 },        /*  ...and enter it */
 { DEFFIX, "rnm",     0720066 },        /* rename mem */
 { DEFFIX, "rsm",     0720667 },        /* reset banks */

 /* Misc IOTs */
 { DEFFIX, "rck",     0720032 },       /* read clk */
 { DEFFIX, "ctb",     0720035 },       /* clear trap buffer */
 { DEFFIX, "rro",     0720017 },       /* rem-rand out */
 { DEFFIX, "rri",     0720037 },       /* ...and in */

 /* Drum IOTs */

 { DEFFIX, "dia",      0720061 },      /* initial addr */
 { DEFFIX, "dwc",      0720062 },      /* word count */
 { DEFFIX, "dcl",      0720063 },      /* core loc */
 { DEFFIX, "dba",      0722061 },      /* break addr */
 { DEFFIX, "dra",      0722062 },      /* req addr */

 /* DCS Type 630 */
 /* More info may be found in the DCS doc in the JOSS-II project */

 { DEFFIX, "rch",      0720022 },      /* recieve either 5- or 8-bit char */
 { DEFFIX, "rrc",      0721022 },      /* recieve and release the mux */
 { DEFFIX, "tcc",      0725022 },      /* transmit and clear */
 { DEFFIX, "tcb",      0724022 },      /* transmit using the send buffer */
 { DEFFIX, "rrc",      0720122 },      /* read reciver counter */
 { DEFFIX, "ssb",      0724122 },      /* set send buffer */
 { DEFFIX, "rsc",      0721122 },      /* clear flag */

 /* Display IOTs other than dpy */

 { DEFFIX, "gpl",      0722007 },     /* Generator plot left */
 { DEFFIX, "gpr",      0720027 },     /* ...and right! */
 { DEFFIX, "gcr",      0720127 },     /* reset */
 { DEFFIX, "glf",      0722026 },     /* load format */
 { DEFFIX, "gsp",      0720026 },     /* space */
 { DEFFIX, "sdb",      0722007 },     /* load buffer w/o intensity */

 /* Character generator */

 { DEFFIX, "gcf",      0720127 },     /* reset and clear pen status */
 { DEFFIX, "gfl",      0722026 },     /* load generator format */
